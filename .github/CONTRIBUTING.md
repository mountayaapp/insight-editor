# Contributing to `insight-editor`
...
- Commit messages and pull requests must respect the
  ...
  [`semantic.yml` file](https://github.com/mountayaapp/insight-editor/blob/main/.github/semantic.yml).
- You sign every Git commits using your real name and real email address. If you
  ...
  ```bash
  $ git commit -s -am "feat(tooling): Upgrade Vite to v7.0.0"
  ```
